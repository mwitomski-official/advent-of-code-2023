...
// Day 12 - 12.12.2023
// Task 12.1 - 7236
HotSpringsManager hotSpringsManager = new();
var sumOfArrangements = hotSpringsManager.GetSumOfCounts();

Console.WriteLine($"Task 12.1 - Your puzzle answer was: {sumOfArrangements}");